...
[![PyPI version](https://badge.fury.io/py/easy-social-share.svg)](https://pypi.org/project/easy-social-share/)
...
```bash
pip install easy-social-share
```

## Quick Start

```python
from easy_social_share import share
...
from easy_social_share import batch
